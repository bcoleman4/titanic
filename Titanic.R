setwd("/Users/Brian/Desktop/Kaggle/")
...
GBreakdown <- table(trainData$Sex, trainData$Pclass)
barplot(GBreakdown, xlab = "Cabin Class", ylab = "Gender Type",
        main = "Gender by Cabin Class")
GBreakdown[1] / (GBreakdown[1] + GBreakdown[2])
GBreakdown[3] / (GBreakdown[3] + GBreakdown[4])
GBreakdown[5] / (GBreakdown[5] + GBreakdown[6])

Gender_survival <- table(trainData$Survived, trainData$Sex)
barplot(Gender_survival, xlab = "Gender", ylab = "Number of People",
        main = "Survived by Gender")
Gender_survival[2] / (Gender_survival[1] + Gender_survival[2])
Gender_survival[4] / (Gender_survival[3] + Gender_survival[4])
